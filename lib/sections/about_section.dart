          ...
          [
            ...
            div(
              ...
              [
                ...
                p(
                  classes: 'font-roboto font-normal text-body-1 text-body leading-relaxed',
                  [
                    .text(
                ...
                div(
                  ...
                  [const AppButton(label: 'Download CV', href: '#')],
                ),
              ],
            ),
            // Right visual
            div(
              ...
              [
                div(
                  classes: 'w-[280px] h-[320px] md:w-[380px] md:h-[420px] '
                  ...
                  [
                    div(
                      ...
                      [
                        ...
                        span(
                          classes: 'font-roboto font-bold text-h3 text-heading mt-4 block',
                          [.text('3+ Years')],
                        ),
                        span(
